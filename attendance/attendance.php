...
xmlhttp.open("GET", "get_records.php?dt="+dt,true);
xmlhttp.send();
							...
							<ul>
								...
								<li>
									<div class="item-inner">
										...
										<p><strong>BEAUTYSPOT</strong><br>Malviya Nagar,Jaipur<br>Ind 401015</p>
									</div>
								</li>
...
<div id="core" class="post-132 page type-page status-publish hentry">
	...
	<div id="page-header">
		<div class="container">
			<h1 class="m-secondary-font">Attendance Record</h1>	
		</div>
	</div>
	<!-- PAGE HEADER : begin -->
	...
	<div class="container">
		...
		<div id="page-content">
			<div class="various-content">
				...
				<div >
					<h3>Select Date To View Attendance of Employee</h3>
					
		<input type="Date" id="dt" onchange="get_record(this.id)">
				</div>
...
<div >
<?php 
$sql2 = "SELECT * FROM attendance where dt=(SELECT MAX(dt) from attendance)";
